...
{   
    ...
    Texture2D listi = LoadTexture("textu/listi.png");
    Texture2D drevo = LoadTexture("textu/drevo.png");
    Texture2D drevo1 = LoadTexture("textu/drevo2.png");
    Texture2D drevotop = LoadTexture("textu/drevotop.png");
    ...
    while (!WindowShouldClose())
    {
       ...
       {    
            ...
            texture_cobblestone, texture_cobblestone_dark, texture_cobblestone_darker, camera.target, camera.position, direction, listi, drevo, drevotop, drevo1);
            //DrawGrid(48, 1);        
            ...
            if(//Kolikze
                ...
                world[(int) camera.position.y - 2][(int) camera.position.z][(int) camera.position.x] == 4 ||
                world[(int) camera.position.y - 2][(int) camera.position.z][(int) camera.position.x] == 5){
    ...
    UnloadModel(rectangleModel);
            ...
            UnloadTexture(listi);
            UnloadTexture(drevo);
            UnloadTexture(drevo1);
            UnloadTexture(drevotop);
