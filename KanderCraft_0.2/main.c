...
int main()
{
    ...
    while (!WindowShouldClose())
    {
       ...
       else if(state == 1)
       {
            ...
            texture_cobblestone, texture_cobblestone_dark, texture_cobblestone_darker);
            //DrawGrid(48, 1);        
            ...
            if(t == 1){
                DrawTextPro(font_regular,"\n\n\n\n\n\n\n\n\nBlock: Dirt", (Vector2){10, 10}, (Vector2){0,0}, 0, 28, 2.0f, WHITE);
            }
            else if(t == 2){
            DrawTextPro(font_regular,"\n\n\n\n\n\n\n\n\nBlock: cobblestone", (Vector2){10, 10}, (Vector2){0,0}, 0, 28, 2.0f, WHITE);
